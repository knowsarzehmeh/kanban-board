...
function ActivityIcon({ width=18, height=18, color="" }) {
  return (
    <svg version="1.1" id="Capa_1" width={width} height={height}  xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px"
    viewBox="0 0 238.126 238.126">
<path color={color} d="M205.071,98.678c-1.194-2.728-3.891-4.49-6.869-4.49h-62.33l30.023-84.167c1.197-3.357-0.134-7.094-3.184-8.938
